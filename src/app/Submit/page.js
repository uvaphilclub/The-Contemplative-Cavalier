...
export default function Page(){
    return (
        <div className="ml-10p sm:ml-15p mr-5p sm:mr-15p" id="Submit">
            ...
            <p className="mt-4"><span className="font-bold">Length: </span>There is no word limit for entries; however, submissions will typically range from 1500 to 5000 (5-15 pages). Conciseness and economy of expression are looked upon favorably.</p>
            ...
            <p className="mt-4"><span className="font-bold">Number of submissions: </span>Not more than three submissions per person per issue of The Contemplative Cavalier is permitted. Resubmissions of the same paper across different issues is allowed provided that there have been appropriate edits. If your piece is accepted,you will receive information on the revision timeline when you are notified of acceptance. </p> 
            <p className="mt-4"><span className="font-bold">Submission method: </span>Anonymous submissions are to be submitted to The Contemplative Cavalier google form. Authors must remove their names from the document and file name. Authors should include their UVA computing ID so that we can contact the appropriate author with our decision.</p> 
            <h1 className="mt-8 text-3xl">Submit to the <span className="underline"><a href="https://docs.google.com/forms/d/e/1FAIpQLSd9T_ZSNdGw-ADtq-GzRU3LM36RqNEG4nFTr7G-133N28AFhQ/viewform">Google Form here</a></span></h1>
             <h1 className="mt-8 text-2xl sm:text-4xl">Policies of Copy Right</h1>
